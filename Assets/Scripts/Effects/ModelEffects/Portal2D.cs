...
public class Portal2D : PostEffectBase
{
    ...
    [Range(0f, 1f)]
    public float emitCenterUVY=.5f;
    [Range(0f, 1f)]
    public float effectOutterHeight=.5f;
    ...
    public void OnRenderImage(RenderTexture source, RenderTexture destination)
    {
        if (material != null)
        {
            ...
            material.SetFloat("_EmitCenterUVY",emitCenterUVY);
            material.SetFloat("_EffectOutterHeight",effectOutterHeight);
            ...
            material.SetFloat("_SeamWitdh", seamWitdh);
            material.SetFloat("_IsHorizontal", isHorizontal?1:0);
